...
class DatasetConfig:
    ...
    verts_sampled: str = f'src/consts/verts_ids_0512.npy'
    verts_feet: str = f'src/consts/feet_verts_ids_0512.npy'
    rh2smplx_ids: str = f'src/consts/rhand_smplx_ids.npy'
    vertex_label_contact: str = f'src/consts/vertex_label_contact.npy'
...
class LossConfig:
    ...
    lh_vertices: Loss = Loss(type='l1', weight= 0)
    ...
    rh_faces: str = f'src/consts/rhand_faces.npy'
    lh_faces: str = f'src/consts/lhand_faces.npy'
    vpe_path: str = f'src/consts/verts_per_edge_rh.npy'
    vpe_b_path: str = f'src/consts/verts_per_edge_body.npy'
    c_weights_path: str = f'src/consts/rhand_weight.npy'
    rh2smplx_idx: str = f'src/consts/rhand_smplx_ids.npy'
    lh2smplx_idx: str = f'src/consts/lhand_smplx_ids.npy'
